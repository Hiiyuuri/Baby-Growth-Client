...
function EditPregnancyData() {
  ...
  return (
    <div>
      ...
      <div
        className="col-md-5 mx-auto border rounded p-5"
        style={{ marginTop: "40px", marginBottom: "40px" }}
      >
        <h1 className="text-2xl font-bold mb-5 text-center">
          {" "}Input/Edit Pregnancy Data
        </h1>
        ...
        >
          ...
          <button className="btn btn-primary btn-lg btn-block bg-success">
            Submit
          </button>
        </form>
        <button className="btn btn-primary btn-lg btn-block bg-danger">
          Cancel
        </button>
      </div>
    </div>
